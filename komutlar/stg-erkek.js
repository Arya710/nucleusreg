...
const tag = ''   
const erkekrol = message.guild.roles.cache.find(r => r.id === '814424837933891615') //erkek rol id
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '814424838348603415')//erkek rol 2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '814424848205348894')//kayıtsız id
const genelchat = message.guild.channels.cache.find(c => c.id === '814838067067093032')//genelchat id
